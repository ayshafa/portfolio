...
@section('content')
    ...
    @if($user && $user->profile_pic)
        <img class="img-fluid w-100 rounded-circle shadow-sm" src="{{ asset('storage/' . $user->profile_pic) }}" alt="{{ $user->name }}">
    @else
        <img class="img-fluid w-100 rounded-circle shadow-sm" src="{{ asset('images/default-avatar.jpg') }}" alt="Default profile">
    @endif
</div>
...
<a href="{{ url('/ayisha_kk.pdf') }}" download class="btn btn-outline-light mr-5">Download CV</a>
